              ...
              <div class="row">
                <div class="col-lg-6 mb-3 mb-lg-0 bg-none main-content">
                  ...
                  <p class="mb-5 text-normal">
                    ...
                    opportunities & highest yields into a single HUB, integrated
                    with first-of-it’s kind enterprise & business solutions to
                    reach the 90% currently without DeFi
                  </p>
          ...
          <div class="container">
            <section class="container-section">
              <div class="text-center overflow-sm-hidden">
                ...
                <img src={DecentralisedIcon} class="img-fluid image-decentralised" />
              </div>
            </section>
          </div>
        </>
      ...
      return (
        <div class="container">
          <section class="container-section text-center">
            <div class="row justify-content-center">
              <div class="col-sm-8">
                <h2 class="heading-small mb-4">Enter dApp</h2>
                <p>
                  Lorem ipsum dolor sit amet, aliquam iferumque ne vix, qui
                  commod An e ne vix, qui com vix, qui commod An e ne vix, qui
                  com
                </p>
                <button class="btn btn-secondary mb-2 mt-4">Enter dApp</button>
              </div>
            </div>
          </section>
        </div>
